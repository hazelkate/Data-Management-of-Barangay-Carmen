  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Username', value: 'attributes.username' },
        { text: 'Email', value: 'attributes.email' },
        { text: 'Contact#', value: 'attributes.contactnumber' },
        { text: 'Role', value: 'attributes.role' },
    ...
    methods: {
      ...
      async init (){
        const response = await Moralis.Cloud.run("getUsers");
